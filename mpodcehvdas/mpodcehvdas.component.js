'use strict';
angular.module('mpodcehvdas', []).component('mpodcehvdas', {
    templateUrl: 'mpodcehvdas/mpodcehvdas.template.html',
    controller: ['$routeParams', '$q', '$http', '$window', '$interval',
        function mpodcehvdasController($routeParams, $q, $http, $window, $interval) {
            this.pageTitle = "NP04 High Voltage DAQ Side";
            this.natalie = 1;
            this.TT0101 = "";
            let self = this;

            this.mpodcehvdasChanger = function(crId) {
                $window.location.href = "#!/mpodcehvdas/";
            ...
            this.reload = function () {
                ...
                element.push("NP04_DCS_V21-CPC_AnalogInput-00009.ProcessInput.PosSt");
                    ...
                    for (let j = 0; j < 4; j++) {
                        for (let k = 0; k < 8; k++) {
                            element.push("MPOD_CE_RACK6_Board" + j + "_Channel0" + k + "_StatusOn");
                            element.push("MPOD_CE_RACK6_Board" + j + "_Channel0" + k + "_MeasurementSenseVoltage");
                            element.push("MPOD_CE_RACK6_Board" + j + "_Channel0" + k + "_MeasurementCurrent");
                        }
                    }
